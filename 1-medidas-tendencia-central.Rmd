...
author:
    name: "[Nadia Veronica Valencia Galina](https://nadiavalencia.github.io)"
...
[Estadísticamente (2022)](https://estadisticamente.com/moda-estadistica/ "Estadísticamente (2022)")
...
```{r}
# Aquí el cálculo de la moda en histograma
hist(muestra, breaks=20)
```

```{r}
#Aqui el calculo de la moda en tabla de frecuencia
